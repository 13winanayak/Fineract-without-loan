...
public class AccountTransferDTO {
    ...
    public AccountTransferDTO(final LocalDate transactionDate, final BigDecimal transactionAmount,
            ...
            Integer transferType, final AccountTransferDetails accountTransferDetails, final String noteText,
            final ExternalId txnExternalId, SavingsAccount toSavingsAccount, final SavingsAccount fromSavingsAccount,
